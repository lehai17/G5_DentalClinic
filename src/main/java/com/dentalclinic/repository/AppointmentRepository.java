...
public interface AppointmentRepository extends JpaRepository<Appointment, Long> {
    ...
    Page<Appointment> findByCustomer_User_IdOrderByDateDescStartTimeDesc(Long userId, Pageable pageable);
    ...
    @Query("SELECT a FROM Appointment a " +
            "WHERE a.customer.user.id = :customerId " +
    ...
    List<Appointment> findUpcomingAppointmentsByCustomerId(
