...
public class StaffService {
    ...
    // 3. Tìm kiếm và lọc nh�n viên an toàn
    ...
    // 5. Lấy thông tin nh�n viên để cập nhật
    public com.dentalclinic.dto.admin.UpdateStaffDTO getStaffForUpdate(Long id) {
        StaffProfile profile = staffProfileRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Không tìm thấy nh�n viên"));
    ...
    public void updateStaff(Long id, com.dentalclinic.dto.admin.UpdateStaffDTO dto) {
        ...
        if (user == null) {
            throw new RuntimeException("Lỗi dữ liệu: Nh�n viên không có tài khoản user");
        }
    ...
    public void deleteStaff(Long id) {
        ...
        try {
            ...
            throw new RuntimeException(
                    "Không thể xóa do tồn tại dữ liệu lịch sử liên kết với nh�n viên này. Vui lòng dùng tính năng 'Khóa'.");
        }
    }
}
